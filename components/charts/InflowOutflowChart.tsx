...
export const InflowOutflowChart: React.FC<InflowOutflowChartProps> = ({ data }) => {
    ...
    <div style={{ width: '100%', height: 400 }}>
        <ResponsiveContainer>
            <BarChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 20 }}>
                ...
                <Bar
                    dataKey="inflows"
                    name={t('m8_cashFlowStatement.chart.inflows') || ''}
                    fill="#22c55e" // green-500
                />
                <Bar
                    dataKey="outflows"
                    name={t('m8_cashFlowStatement.chart.outflows') || ''}
                    fill="#ef4444" // red-500
                />
            </BarChart>
        </ResponsiveContainer>
